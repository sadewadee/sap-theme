<?php
add_action('widgets_init', 'reedwan_homepage_09col_load_widgets');

function reedwan_homepage_09col_load_widgets()
{
	register_widget('Reedwan_homepage_09col_Widget');
}

class Reedwan_homepage_09col_Widget extends WP_Widget {
	
	function Reedwan_homepage_09col_Widget()
	{
		$widget_ops = array('classname' => 'reedwan_homepage_09col', 'description' => '22 Column magazine recent posts widget for magazine widget.');

		$control_ops = array('id_base' => 'reedwan_homepage_09col-widget');

		$this->WP_Widget('reedwan_homepage_09col-widget', '#INDEX video', $widget_ops, $control_ops);
	}
...
<div class="item" style="background:#FF0000; text-align:center">
        <div class="grid">
...
<?php }?>
      ...
      <div class="frame"><iframe width="700" height="386" src="https://www.youtube.com/watch?v=XlaaNqj-mTM" frameborder="0" allowfullscreen></iframe></div>      
