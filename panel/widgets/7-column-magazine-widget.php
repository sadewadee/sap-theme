<?php
add_action('widgets_init', 'reedwan_homepage_7col_load_widgets');

function reedwan_homepage_7col_load_widgets()
{
	register_widget('Reedwan_Homepage_7col_Widget');
}

class Reedwan_Homepage_7col_Widget extends WP_Widget {
	
	function Reedwan_Homepage_7col_Widget()
	{
		$widget_ops = array('classname' => 'reedwan_homepage_7col', 'description' => '22 Column magazine recent posts widget for magazine widget.');

		$control_ops = array('id_base' => 'reedwan_homepage_7col-widget');

		$this->WP_Widget('reedwan_homepage_7col-widget', '#INDEX Recent', $widget_ops, $control_ops);
	}
...
?>
         <?php echo category_description($categories); ?>
         <br />
...
<?php endif; ?>
 ...
 <figcaption>  
 	<h3><a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>'><?php the_title(); ?></a></h2>
	<p><?php echo string_limit_words(get_the_excerpt(), 10); ?></p>	
<a class="button or" href="<?php the_permalink(); ?>">DETAILS</a>
 </figcaption>    
</figure>
